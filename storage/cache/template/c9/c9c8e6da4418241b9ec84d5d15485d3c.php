...
class __TwigTemplate_10a87c1cdb08c60fbefa772bbda90c2f extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "admin/view/template/user/user.twig", "/var/www/robinandrooks.com/upload/admin/view/template/user/user.twig");
    }
}
